...
UK_ST1_coded <- UK_ST1_coded[!(UK_ST1_coded$Stone.Coded == 4), ]
UK_ST1_non_coded <- UK_ST1[, -15]
UK_ST1_non_coded <-
  UK_ST1_non_coded[!(UK_ST1_non_coded$Stone_type == "Unknown"), ]
...
Swiss_ST_coded <-
  Swiss_ST_coded[!(Swiss_ST_coded$Stone.Coded == 4), ]
Swiss_ST_non_coded <- Swiss_ST[, -15]
Swiss_ST_non_coded <-
  Swiss_ST_non_coded[!(Swiss_ST_non_coded$Stone_type == "Unknown"), ]
Swiss_ST_non_coded$Stone_type <-
  factor(Swiss_ST_non_coded$Stone_type,
         levels = c("CaOx",
                    "CaP",
                    "Urate"))
...
UK_ST1_coded_imputed <-
  subset(UK_ST1_coded_imputed,
         select = -c(Hyperuricosuria,
                     Hyperoxaluria,
...
UK_ST1_non_coded_imputed <-
  UK_ST1_non_coded_imputed %>% select(-Hyperuricosuria)
UK_ST1_non_coded_imputed <-
...
UK_Rec_non_coded_imputed <-
  UK_Rec_non_coded_imputed %>% mutate(Hyperuricosuria = ifelse(Urine_urate_mmol_24h >
                                                                 4.46, "Yes", "No")) %>% na.omit()
UK_Rec_non_coded_imputed$Hyperuricosuria <-
  factor(UK_Rec_non_coded_imputed$Hyperuricosuria,
         levels = c("Yes",
                    "No"))
...
UK_ST1_coded <- UK_ST[,-14] %>% drop_na(Stone.Coded)
UK_ST1_coded <- UK_ST1_coded[!(UK_ST1_coded$Stone.Coded == "4"),]
UK_ST1_coded <- na.omit(UK_ST1_coded)
UK_ST1_coded$Stone.Coded<-factor(UK_ST1_coded$Stone.Coded,
                                 levels = c("1",
                                            "2",
                                            "3"))
...
UK_ST1_non_coded <- na.omit(UK_ST1_non_coded)
UK_ST1_non_coded <-
  UK_ST1_non_coded[!(UK_ST1_non_coded$Stone_type == "Unknown"), ]
UK_ST1_non_coded$Stone_type <- factor(UK_ST1_non_coded$Stone_type,
                                      levels = c("CaOx",
...
UK_Rec_coded_oversample1 <- ROSE::ovun.sample(Rec_coded ~ .,
                                              ...
                                              seed = 1234)
UK_Rec_coded_oversample <-
  UK_Rec_coded_oversample1$data %>% as_tibble() %>% na.omit()
...
UK_Rec_non_coded_oversample <-
  UK_Rec_non_coded_oversample %>% drop_na(Recurrence)
UK_Rec_non_coded_oversample1 <- ROSE::ovun.sample(Recurrence ~ .,
                                                  UK_Rec_non_coded_oversample,
                                                  method = "over",
                                                  seed = 1234)
UK_Rec_non_coded_oversample <-
  UK_Rec_non_coded_oversample1$data %>% as_tibble() %>% na.omit()
