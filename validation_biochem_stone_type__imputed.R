...
Swiss_ST_keras_prediction_all_one_imputed <-
  Swiss_ST_keras_prediction2_imputed %>% mutate(Stone_type = case_when(CaOx > 0.4 ~ "CaOx",
                                                               CaP >
                                                                 0.4 ~ "CaP",
                                                               Urate >
                                                                 0.4 ~ "Urate"))
Swiss_ST_keras_prediction_all_one_imputed$Stone_type <- factor(Swiss_ST_keras_prediction_all_one_imputed$Stone_type,
                                                       levels = c("CaOx",
                                                                  "CaP",
                                                                  "Urate"))
Swiss_ST_test_coded_outcome_all_one_imputed <-
  Swiss_ST_test_coded_outcome3 %>% mutate(Stone_type = case_when(CaOx == 1 ~ "CaOx",
                                                                 CaP ==
                                                                   1 ~ "CaP",
                                                                 Urate ==
                                                                   1 ~ "Urate"))
Swiss_ST_test_coded_outcome_all_one_imputed$Stone_type <-
  factor(
    Swiss_ST_test_coded_outcome_all_one_imputed$Stone_type,
    levels = c("CaOx",
               "CaP",
...
Swiss_ST_keras_tb_imputed <-
  table(ref = Swiss_ST_test_coded_outcome_all_one_imputed$Stone_type, 
        pred = Swiss_ST_keras_prediction_all_one_imputed$Stone_type)
confusionMatrix(Swiss_ST_keras_tb_imputed)
Swiss_ST_keras_multiclass_roc_imputed <- multiclass.roc(Swiss_ST_test_coded_outcome_all_one_imputed$Stone_type,
                                                as.data.frame(Swiss_ST_keras_prediction2_imputed))
